...
static const TargetInfo targetInfos[int(Routing::Target::Last)] = {
    ...
    // Tuesday targets
    [int(Routing::Target::Algorithm)]                       = { 0,      15,     0,      15,     1       },
    ...
    [int(Routing::Target::StochasticMask)]               = { 0,      100,    0,      100,    10      },
    [int(Routing::Target::StochasticGateLength)]      = { 0,      100,    0,      100,    10      },
    [int(Routing::Target::StochasticTilt)]                  = { -100,   100,    0,      100,    10      },
    [int(Routing::Target::StochasticFeel)]                    = { 0,      100,    0,      100,    50      },
    ...
    [int(Routing::Target::StochasticNoteDuration)]         = { 0,      7,      0,      7,      1       },
