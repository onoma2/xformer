...
constexpr RouteParam::Row kRows[] = {
    { NoteParamTable::SlideTime, "Slide Time",  {   0.f,  100.f }, RouteParam::Continuous, applySlideTime },
    { NoteParamTable::Octave,    "Octave",      { -10.f,   10.f }, RouteParam::Continuous, applyOctave },
    { NoteParamTable::Transpose, "Transpose",   { -60.f,   60.f }, RouteParam::Continuous, applyTranspose },
    { NoteParamTable::Rotate,    "Rotate",      { -64.f,   64.f }, RouteParam::Continuous, applyRotate },
    { NoteParamTable::GateProbabilityBias,      "Gate P. Bias",   { -8.f, 8.f }, RouteParam::Continuous, applyGateBias },
    { NoteParamTable::RetriggerProbabilityBias, "Retrig P. Bias", { -8.f, 8.f }, RouteParam::Continuous, applyRetrigBias },
    { NoteParamTable::LengthBias,               "Length Bias",    { -8.f, 8.f }, RouteParam::Continuous, applyLengthBias },
    { NoteParamTable::NoteProbabilityBias,      "Note P. Bias",   { -8.f, 8.f }, RouteParam::Continuous, applyNoteBias },
    { NoteParamTable::Scale,     "Scale",       {   0.f,   23.f }, RouteParam::Discrete,   applyScale },
    { NoteParamTable::RootNote,  "Root Note",   {   0.f,   11.f }, RouteParam::Discrete,   applyRootNote },
    { NoteParamTable::Divisor,   "Divisor",     {   1.f,  768.f }, RouteParam::Discrete,   applyDivisor },
    { NoteParamTable::ClockMult, "Clock Mult",  {  50.f,  150.f }, RouteParam::Continuous, applyClockMult },
    { NoteParamTable::RunMode,   "Run Mode",    {   0.f,    5.f }, RouteParam::Discrete,   applyRunMode },
    { NoteParamTable::FirstStep, "First Step",  {   0.f,   63.f }, RouteParam::Discrete,   applyFirstStep },
    { NoteParamTable::LastStep,  "Last Step",   {   0.f,   63.f }, RouteParam::Discrete,   applyLastStep },
};
