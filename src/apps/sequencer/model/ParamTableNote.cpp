...
constexpr RouteParam::Row kRows[] = {
    ...
    { ParamKey::Transpose, "Transp",      { -60.f,   60.f }, RouteParam::Continuous, applyTranspose },
    { ParamKey::Rotate,    "Rotate",      { -64.f,   64.f }, RouteParam::Continuous, applyRotate },
    { ParamKey::GateProbabilityBias,      "Gate PB",        { -8.f, 8.f }, RouteParam::Continuous, applyGateBias },
    { ParamKey::RetriggerProbabilityBias, "Rtrg PB",        { -8.f, 8.f }, RouteParam::Continuous, applyRetrigBias },
    { ParamKey::LengthBias,               "Len Bias",       { -8.f, 8.f }, RouteParam::Continuous, applyLengthBias },
    { ParamKey::NoteProbabilityBias,      "Note PB",        { -8.f, 8.f }, RouteParam::Continuous, applyNoteBias },
    { ParamKey::Scale,     "Scale",       {   0.f,   23.f }, RouteParam::Discrete,   applyScale },
    { ParamKey::RootNote,  "Root N",      {   0.f,   11.f }, RouteParam::Discrete,   applyRootNote },
    { ParamKey::Divisor,   "Divisor",     {   1.f,  768.f }, RouteParam::Discrete,   applyDivisor },
    { ParamKey::ClockMultiplier, "Clk Mlt",     {  50.f,  150.f }, RouteParam::Continuous, applyClockMult },
