...
tele_error_t scanner(const char *data, tele_command_t *out,
    ...
    %%{
        ...
        action token {
            ...
            if (match_token(buf, len, &tele_data)) {
                ...
                cmd_set(out, out->length, tele_data.tag, tele_data.value);
        ...
        action pre_separator {
            ...
            cmd_set(out, out->length, PRE_SEP, 0);
        ...
        action sub_separator {
            ...
            cmd_set(out, out->length, SUB_SEP, 0);
