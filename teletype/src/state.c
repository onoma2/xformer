...
static int16_t tracklite_in_min = 0;
static int16_t tracklite_in_max = 16383;
static int16_t tracklite_param_min = 0;
static int16_t tracklite_param_max = 16383;
#endif
...
#if TELETYPE_TRACK_LITE
    ss->variables.param_scale = scale_init(tracklite_param_min,
                                           tracklite_param_max,
...
#if TELETYPE_TRACK_LITE
    ss->variables.in_scale = scale_init(
        tracklite_in_min, tracklite_in_max, ss->variables.in_range.out_min,
...
#if TELETYPE_TRACK_LITE
    (void)ss;
    tracklite_param_max = 16383;
    tracklite_param_min = 0;
    ss_update_param_scale(ss);
#else
    ss->cal.p_max = 16383;
    ss->cal.p_min = 0;
