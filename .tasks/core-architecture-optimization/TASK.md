...
- 2026-05-14: Corrected stale model-container sizing: host probes indicate CurveTrack (~10,092 B), not NoteTrack (~9,612 B), currently dominates `Track::_container`; ARM sizeof verification is still required before counting model savings.
