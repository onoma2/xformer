...
- **Deferred:** phase 6 remaining: **Indexed** (also has inlets — apply the base-0 + isInletTarget pattern; DiscreteMapSync inlet retired there too), MidiCv optional (2 params). Then phase 7 MIDI LEARN (F4→F1) + shaper, phase 9 delete old writeTarget/Routable half. Eligibility diff in spec §17.
