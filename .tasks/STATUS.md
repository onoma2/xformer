...
**Reference:** `.tasks/stochastic-track-port/PHASE17-SEED-DELTA.md` (refreshed 2026-05-24 — structural cleanup track: anchor/cluster + BurstHold renames, drop dead event fields, Repeat-path burst re-roll, mutate redesign + lock semantic open), `.tasks/stochastic-track-port/PHASE15-PITCH-MATH-REVIEW.md` (refreshed 2026-05-24 — pitch-law track: Marbles continuous Bias/Spread, Range bipolar, ticket transparency, layer ownership, Slide score-based; independent of PHASE17), `.scratch/stochastic-knob-ownership.html` (current knob inventory, single source of truth for the seed/domain contract)
