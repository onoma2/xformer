...
- **Deferred:** phase 6 remaining engines (Tuesday → Stochastic → DiscreteMap → Indexed, same pattern; MidiCv optional 2 params), phase 7 MIDI LEARN (F4→F1) + shaper, phase 9 delete old writeTarget/Routable half. Eligibility diff in spec §17.
