...
**Where I stopped:** Last commit `198b46c6` — multi-cell selection. All shipped behavior verified in sim build (build/sim/debug + build/stm32/release both clean). 5 commits behind tt2-v2-native sibling on feat/stochastic-seed-log parent; merge to parent ready (see git-discipline notes in chat history).
